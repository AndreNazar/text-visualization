...
import { embeddingsTo2D } from './shared/lib/ml/embeddingsTo2D'
import type { RowType } from './entities/Row/types/Row.type'
import type { PointType } from './entities/Point/types/Point.type'
import { clusterByDBSCAN } from './shared/lib/ml/clusterByDBSCAN'
  ...
  return (
    <HashRouter>
      <Routes>
        <Route
          path="/visualization"
          element={<VisualizationCanvas visualPoints={visualPoints} />}
        />
